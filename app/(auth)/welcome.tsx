        ...
        <View style={styles.container}>
            <View>
                ...
                <View style={styles.footer}>
                    <Animated.View entering={FadeInDown.duration(1000).springify().damping(12)} style={{
                        alignItems: 'center'    
                    }}>
                        <Typo size={30} fontWeight={"800"}>Always take controll</Typo>
                    ...
                    <Animated.View entering={FadeInDown.duration(1000).delay(200).springify().damping(12)} style={styles.buttonContainer}>
                       <Button onPress={() => router.push('/(auth)/register')}>
                            <Typo color={colors.neutral900} size={22} fontWeight={"600"}>Get Started</Typo>
                        </Button> 
                    </Animated.View>
                </View>
        </View>
